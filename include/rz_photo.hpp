...
public:
    ...
    inline static const QStringList metaSupportedTypes = {
    ...
    // --- Settings & Getter ---
    void setOversizeSmallerPicture(bool enable) { oversizeSmallerPicture_bool = enable; }
    void setOverwriteExistingWebp(bool enable) { overwriteExitingWebp_bool = enable; }
